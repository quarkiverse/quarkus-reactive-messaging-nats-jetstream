...
/**
 * A record that serves as a delegate implementation of the {@link NativeJetStream} interface. This class
 * wraps an instance of {@link io.nats.client.JetStream} and delegates all method calls to the wrapped
 * instance.
 */
