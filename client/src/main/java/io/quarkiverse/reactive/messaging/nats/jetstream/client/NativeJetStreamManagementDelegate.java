...
/**
 * A record that acts as a delegate for managing JetStream resources. This class implements
 * the {@link io.nats.client.JetStreamManagement} interface, providing methods to manage
 * streams, consumers, key-value stores, and object stores within a JetStream context.
 * The {@code JetStreamManagementDelegate} wraps an instance of {@link io.nats.client.JetStreamManagement}
 * and delegates all operations to the underlying instance. This allows for additional functionality,
 * if needed, while maintaining the same interface as the original {@link io.nats.client.JetStreamManagement}.
 */
record NativeJetStreamManagementDelegate(io.nats.client.JetStreamManagement delegate) implements NativeJetStreamManagement {
    ...
    @Override
    public io.nats.client.KeyValueManagement keyValueManagement() throws IOException {
    ...
    @Override
    public io.nats.client.ObjectStoreManagement objectStoreManagement() throws IOException {
