...
public interface ObjectStore {
    ...
    /**
     * Retrieves the name of the bucket associated with the object store.
     *
     * @return the name of the bucket as a non-null string.
     */
    @NonNull
    String bucketName();
     ...
     */
    @NonNull
    Uni<ObjectInfo> put(@NonNull ObjectMetadata metadata, byte @NonNull [] data);
     ...
     */
    @NonNull
    Uni<ObjectInfo> put(@NonNull String objectName, byte @NonNull [] data);
     ...
     */
    @NonNull
    Uni<ObjectEntry> get(@NonNull String objectName);
     ...
     */
    @NonNull
    Uni<ObjectInfo> info(@NonNull String objectName);
     ...
     */
    @NonNull
    Uni<ObjectInfo> info(@NonNull String objectName, boolean includingDeleted);
     ...
     */
    @NonNull
    Uni<ObjectInfo> update(@NonNull String objectName, @NonNull ObjectMetadata metadata);
     ...
     */
    @NonNull
    Uni<ObjectInfo> delete(@NonNull String objectName);
     ...
     */
    @NonNull
    Uni<ObjectInfo> link(@NonNull String objectName, @NonNull ObjectInfo toInfo);
     ...
     */
    @NonNull
    Uni<ObjectInfo> link(@NonNull String objectName, @NonNull ObjectStore store);
