...
public interface MessageMapper {
     ...
     */
    static @NonNull MessageMapper of(Serializer serializer) {
     ...
     */
    @NonNull Message<byte[]> map(org.eclipse.microprofile.reactive.messaging.@NonNull Message<?> message);
     ...
     */
    <T> org.eclipse.microprofile.reactive.messaging.@NonNull Message<T> map(@NonNull Message<byte[]> message);
     ...
     */
    <T> org.eclipse.microprofile.reactive.messaging.@NonNull Message<T> map(@NonNull Message<byte[]> message, @NonNull Class<T> payloadType);
}
