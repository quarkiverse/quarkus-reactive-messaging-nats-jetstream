...
quarkus.reactive-messaging.nats.jet-stream.streams[0].name=test
quarkus.reactive-messaging.nats.jet-stream.streams[0].subjects[0]=data
...
quarkus.reactive-messaging.nats.jet-stream.streams[i].name,Name of the stream to setup if auto-configure is enabled
quarkus.reactive-messaging.nats.jet-stream.streams[i].subjects[n],Name of the subject in stream to setup if auto-configure is enabled
|======
