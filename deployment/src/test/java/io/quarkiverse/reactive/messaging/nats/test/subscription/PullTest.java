...
import io.quarkiverse.reactive.messaging.nats.test.Advisory;
import io.quarkiverse.reactive.messaging.nats.test.MessageConsumer;
import io.quarkiverse.reactive.messaging.nats.test.TestSpanExporter;
...
class PullTest {
    ...
    static final QuarkusExtensionTest config = new QuarkusExtensionTest().setArchiveProducer(
            ...
            .withConfigurationResource("application-pull.properties");
