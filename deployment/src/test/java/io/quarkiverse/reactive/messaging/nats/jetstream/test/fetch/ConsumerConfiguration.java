...
public record ConsumerConfiguration(String stream, String name, String subject) implements io.quarkiverse.reactive.messaging.nats.jetstream.client.consumer.ConsumerConfiguration<Object> {
