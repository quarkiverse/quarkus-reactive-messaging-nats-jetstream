...
import static io.quarkiverse.reactive.messaging.nats.jetstream.JetStreamContainer.NATS_PORT;
import static io.quarkiverse.reactive.messaging.nats.jetstream.connector.deployment.JetStreamProcessor.FEATURE;
...
public class JetStreamDevServicesProcessor {
    ...
    public void startJetstreamContainer(LaunchModeBuildItem launchMode,
        ...
        JetStreamDevServicesBuildTimeConfiguration devServicesBuildTimeConfiguration = configuration.devservices();
                        ...
                        .produce(DevServicesResultBuildItem.owned().feature(FEATURE)
                                ...
                                .startable(
                                        () -> new JetStreamContainer(
                                                ...
                                                devServicesBuildTimeConfiguration.port().orElse(null),
                                                composeProjectBuildItem.getDefaultNetworkId(), useSharedNetwork,
                                                containerConfiguration(devServicesBuildTimeConfiguration))
    ...
    private JetStreamContainerConfiguration containerConfiguration(JetStreamDevServicesBuildTimeConfiguration configuration) {
        return JetStreamContainerConfiguration.of(
