...
import static io.quarkiverse.reactive.messaging.nats.deployment.JetStreamContainer.NATS_PORT;
import static io.quarkiverse.reactive.messaging.nats.deployment.JetStreamProcessor.FEATURE;
