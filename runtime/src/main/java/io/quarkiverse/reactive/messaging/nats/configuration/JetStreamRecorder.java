package io.quarkiverse.reactive.messaging.nats.configuration;

import jakarta.enterprise.inject.spi.CDI;

import io.quarkiverse.reactive.messaging.nats.client.Client;
import io.quarkiverse.reactive.messaging.nats.configuration.mapper.KeyValueStoreConfigurationMapper;
import io.quarkiverse.reactive.messaging.nats.configuration.mapper.PullConsumerConfigurationMapper;
import io.quarkiverse.reactive.messaging.nats.configuration.mapper.PushConsumerConfigurationMapper;
import io.quarkiverse.reactive.messaging.nats.configuration.mapper.StreamConfigurationMapper;
