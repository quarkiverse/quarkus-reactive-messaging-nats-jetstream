...
public interface StreamConfigurationMapper {
    ...
    default io.nats.client.api.StreamConfiguration map(StreamConfiguration streamConfiguration) {
    ...
    default StreamConfiguration map(io.nats.client.api.StreamConfiguration configuration) {
