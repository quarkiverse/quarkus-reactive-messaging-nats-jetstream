...
import io.quarkiverse.reactive.messaging.nats.client.publisher.PublisherAwareImpl;
import io.quarkiverse.reactive.messaging.nats.client.store.KeyValueConfigurationMapper;
...
public class ClientImpl implements Client {
    ...
    @Override
    public <T> Uni<Message<T>> publish(Message<T> message, String stream, String subject, PublishListener<T> listener) {
