...
public class DefaultNativeConnectionListener implements io.nats.client.ConnectionListener {
    private final static Logger log = Logger.getLogger(DefaultNativeConnectionListener.class);
