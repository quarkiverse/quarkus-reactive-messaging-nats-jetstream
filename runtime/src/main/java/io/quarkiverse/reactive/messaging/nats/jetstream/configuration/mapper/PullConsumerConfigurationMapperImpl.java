...
@ApplicationScoped
public record PullConsumerConfigurationMapperImpl(ConsumerConfigurationMapper consumerConfigurationMapper) implements PullConsumerConfigurationMapper {
    ...
    private PullConfiguration map(io.quarkiverse.reactive.messaging.nats.jetstream.configuration.PullConfiguration configuration) {
