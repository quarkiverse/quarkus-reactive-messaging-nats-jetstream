...
/**
 * Raised when a {@link RequestReply#request(Object)} call does not receive its reply within the configured
...
public class TimeoutException extends RuntimeException {
    ...
    public TimeoutException(String correlationId, long timeoutMillis) {
