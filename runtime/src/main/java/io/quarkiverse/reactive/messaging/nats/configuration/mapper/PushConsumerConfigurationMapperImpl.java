...
import io.quarkiverse.reactive.messaging.nats.client.consumer.PushConfigurationImpl;
...
public class PushConsumerConfigurationMapperImpl implements PushConsumerConfigurationMapper {
    ...
    private PushConfiguration map(
            io.quarkiverse.reactive.messaging.nats.configuration.PushConfiguration configuration) {
