...
import io.quarkiverse.reactive.messaging.nats.client.consumer.PullConfigurationImpl;
...
public class PullConsumerConfigurationMapperImpl implements PullConsumerConfigurationMapper {
    ...
    private PullConfiguration map(
            io.quarkiverse.reactive.messaging.nats.configuration.PullConfiguration configuration) {
